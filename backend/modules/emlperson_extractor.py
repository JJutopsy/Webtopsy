        ...
        try:
            ...
            for contact in unique_contacts:
                ...
                for individual_contact in set(contacts_list):
                    ...
                    cursor.execute('''
                        INSERT INTO emlPerson (emlPerson, relatedPerson) VALUES (?, ?)
                    ''', (individual_contact, related_person_str))

            cursor.execute('''
                CREATE TABLE emlPerson_temp AS
                SELECT emlPerson, GROUP_CONCAT(DISTINCT relatedPerson) AS relatedPerson
                FROM emlPerson
                GROUP BY emlPerson
            ''')
